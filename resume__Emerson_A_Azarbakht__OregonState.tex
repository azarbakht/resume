...
%\parbox{\textwidth-\rcollength-\spacewidth}{%
\parbox{\textwidth}{%
(347) 276-0790 \hfill San Francisco, CA  94134\\
\email{azarbaka@oregonstate.edu}\\
...
\section{Specialty}
\textbf{Research Scientist Skilled in Statistics, Machine Learning, \& User Experience Design}\\
\hrule

\section{\footnotesize{Nationality}}
\footnotesize {Canadian Permanent Resident, Eligible to work in the U.S.}\\
\hrule

\section{\normalsize{Education}}
\normalsize
		\textbf{Ph.D., Computer Science}, \href{http://www.oregonstate.edu/}{\textit{Oregon State University}}    	\hfill \textit{2011-2016\\}
...
% | M.S. Advisors: Prof. Palle Dahlstedt \& Prof. Claes Strannegard\\
    	\textbf{B.S., Computer Engineering}, \textit{Azad University of Tehran}    	\hfill \textit{2004-2008\\}
...
\section{Experience}
\textbf{Data Science Research Assistant,} \textit{School of Computer Science, Oregon State University}\\ 
\href{http://eecs.oregonstate.edu/research/research-areas/software-engineering-hci-programming-languages}{\textit{Software Engineering, Usability \& Programming Languages Lab}}\hfill \textit{2011-present} \\
...
\href{http://eecs.oregonstate.edu/people/azarbakht} {\textbf{User Experience Design Instructor,}} \textit{School of Computer Science, Oregon State University}
...
Helped 880 post-baccalaureate students learn user experience skills, to switch into CS careers. \\


\textbf{Data Structures Teaching Assistant,} \textit{School of Computer Science, Oregon State University} \\
...
Wrote shell scripts to automate compilation, runtime and grading \& helped students debug C code.\\

\hrule
\section{Projects}

\href{https://github.com/azarbakht/prelim/raw/master/report.pdf}{\textbf{A Statistical Approach for Modeling Change in Social Networks}} \hfill \textit{2014}\newline
Developed a comparative approach to quantify social dynamics, found a well-fitting statistcal model of covariates for longitudinal changes in social graphs.
...
\item \textbf{Statistical Methods of Data Analysis}
