...
\section{\normalsize{Education}}
\normalsize
		\textbf{Ph.D., Computer Science}, \href{http://www.oregonstate.edu/}{\textit{Oregon State University}}    	\hfill \textit{2017\\}
...
\textit{Longitudinal analysis \& statistical modeling of collaboration graphs of software development}\\
		\textbf{M.S., Computer Science}, \href{http://www.chalmers.se/en/}{\textit{Chalmers University}}, Sweden     	\hfill \textit{2011\\}
...
\textbf{Senior Data Scientist,} \textit{\textbf{Yahoo! Search Analytics Team}}\textit{/Oath Inc.} \hfill \textit{Sept 2017 - present}\\
Worked with product teams to understand problems \\ 
Analyzed data, delivered actionable insights to improve user experience and monetization.\\
Presented findings and influenced product and business decisions.\\


\textbf{Instructor,} \textit{School of Computer Science, Oregon State University}\\
\href{http://classes.engr.oregonstate.edu/eecs/spring2016/cs352/}{\textit{Open Source Software Development {\scriptsize (CS 464)}}}\hfill \textit{Fall 2017 - June 2017s}\\ 
\href{http://classes.engr.oregonstate.edu/eecs/spring2016/cs352/}{\textit{User Experience Design {\scriptsize (CS 352)}}}\hfill \textit{2014-2016}\\ 
Helped 1,070 post-baccalaureate students switch careers and get CS jobs. \\
Helped 500+ students debug C programs. Wrote Bash shell scripts to automate compilation, execution and grading
Developed a CS course for the OSU Online CS program. (Ranked \#7 in the United States)\\
