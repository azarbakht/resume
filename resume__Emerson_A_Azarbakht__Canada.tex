...
%\parbox{\textwidth-\rcollength-\spacewidth}{%
\parbox{\textwidth}{%
(347) 276-0790 \hfill Toronto, Canada\\
\email{emerson.azarbakht@gmail.com} \hfill {\footnotesize Canadian Permanent Resident}\\
...
%{\small Canadian Permanent Resident}\\
%\hrule
...
Databases: \textbf{MySQL, Neo4j, SQL, Cypher, Hive}\\
...
Tools: \textbf{Git, Knitr, Shiny, Markdown, Linux, Hadoop, IPython, NumPy, Pandas, Matplotlib, Scikit-Learn}\\
% add: Apache Spark, TensorFlow
\hrule 

\section{\normalsize{Education}}
\normalsize
		\textbf{Ph.D., Computer Science}, \href{http://www.oregonstate.edu/}{\textit{Oregon State University}}, USA    	\hfill \textit{2011-2017\\}
...
\textit{Longitudinal analysis \& statistical modeling of collaboration graphs of software development}\\
		\textbf{M.S., Computer Science}, \href{http://www.chalmers.se/en/}{\textit{Chalmers University of Technology}}, Sweden     	\hfill \textit{2009-2011\\}
...
\section{Experience}
\href{http://eecs.oregonstate.edu/people/azarbakht} {\textbf{Data Science Research Assistant},} \textit{School of Computer Science, Oregon State University}\\ 
...
Developed statistical models for changing social networks. {\small (Think how \textit{your} \href{http://linkedin.com/in/azarbakht}{LinkedIn} network has changed over time \& what that says about you \& your workplaces.)}\\
...
\textbf{Graduate Teaching Assistant,} \textit{School of Computer Science, Oregon State University} \\
\href{http://catalog.oregonstate.edu/CourseDetail.aspx?subjectcode=CS&coursenumber=261}{\textit{Data Structures {\scriptsize (CS 261)}}}\hfill \textit{2012-2014}
